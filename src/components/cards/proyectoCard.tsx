    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between w-full px-3 py-2">
                <h3 className="text-lg sm:text-xl font-semibold text-white/95 leading-tight line-clamp-1">
                    {decodedTitle}
                </h3>
                <div className="flex items-center gap-2">
                    ...
                    >
                        <Image src="/svg/github-mark.png" alt="GitHub" width={22} height={22} />
                    </button>
                    {demolink ? (
                        <button
                            type="button"
                            ...
                            className="inline-flex items-center justify-center rounded-full cursor-pointer p-1 hover:scale-105 hover:bg-white/5 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-300/60"
                        >
                            <Image src="/svg/hyperlink.png" alt="Demo" width={26} height={26} />
                        </button>
                    ) : null}
                </div>
            </div>
