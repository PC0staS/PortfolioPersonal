export default function Contacto() {
  return (
    <div
      id="contacto"
      className="mt-20 mx-4 flex flex-col items-center justify-center min-h-[20vh] bg-[#1e1e1e] rounded-xl shadow-lg p-6 sm:p-8"
    >
      <h2 className="text-2xl sm:text-3xl font-bold bg-clip-text text-white text-center">
        ¡Hablemos!
      </h2>
      <p className="text-base sm:text-lg text-gray-400 mb-6 sm:mb-8 text-center max-w-md">
        ¿Te gustaría colaborar, tienes alguna pregunta o solo quieres saludar?
        ¡Estoy disponible!
      </p>
      <div className="flex flex-row items-center gap-6 sm:gap-8">
        <a
          href="mailto:pablocostasnieto@gmail.com"
          className="flex items-center gap-2 text-xl font-semibold text-white cursor-pointer hover:scale-105 transition-transform p-2"
        >
          <svg
